...
const ChatBox = () => {
  ...
  const flatListRef = useRef<FlatList>(null); // Ref for auto-scroll
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={{ marginLeft: 10 }}>
            <Text style={styles.userName}>{conversation.participant.name}</Text>
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{ flex: 1 }}>
            {/* Chat List using FlatList for better Messenger experience */}
            <FlatList
              ref={flatListRef}
              data={chatMessages}
...
// ... OptionBtn and styles remain largely same as yours, just ensured height/spacing is consistent ...
...
const styles = StyleSheet.create({
  // ... Keep all your previous styles here ...
  header: {
    flexDirection: "row",
    alignItems: "center",
    padding: 15,
