...
const PersonalInfoScreen = () => {
    ...
    const InfoRow = ({ icon, label, value }: { icon: any, label: string, value: string }) => (
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
            ...
            <View>
                <Text style={{ fontSize: 13, color: '#9CA3AF', marginBottom: 2 }}>{label}</Text>
                <Text style={{ fontSize: 16, color: '#1F2937', fontWeight: '600' }}>{value}</Text>
            </View>
        </View>
    );
            ...
            <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 40 }}>
                ...
                <View style={{
                    ...
                    <InfoRow
                        label="Date of Birth"
                        value={user.dob}
                        icon={<Ionicons name="calendar-outline" size={24} color="#9CA3AF" />}
                    />
                </View>
                ...
                <View style={{
                    ...
                    <InfoRow
                        label="Email"
                        value={user.email}
                        icon={<MaterialIcons name="mail-outline" size={24} color="#9CA3AF" />}
                    />
                    <InfoRow
                        label="Phone"
                        value={user.phone}
