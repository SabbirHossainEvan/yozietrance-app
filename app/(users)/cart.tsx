...
//   // 4. Accumulator typing is inferred, but good to keep an eye on
...
//             onPress={() => router.push("/(users)/Information" as any)} // Cast string to any if router paths aren't strictly typed
//           >
